        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    if(isset($_GET['erro']))
                        if($_GET['erro'] == 1)
                            echo '<div class="alert alert-danger" role="alert"> <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><span class="sr-only">Erro:</span> Esse nome de usuário já existe! </div>'
                    ?>
