<?php
include ('header.php');
$trabalhos = $DB->fetchAll("SELECT trabalho.titulo, trabalho.usuario, trabalho.dataUpload, trabalho.caminho, trabalho.caminho, materia.nome, alm_users.username FROM trabalho, materia, alm_users where trabalho.materia = materia.idmateria and alm_users.id = trabalho.usuario LIMIT 10");
